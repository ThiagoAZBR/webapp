...
class Transacao(models.Model):
    ...
    conta = models.OneToOneField(Contas_bancarias, on_delete=models.RESTRICT, blank=False, null=False)
    categoria_transacao = models.OneToOneField(Categoria_transacao, on_delete=models.RESTRICT, blank=False, null=False)
