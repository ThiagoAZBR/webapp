...
from transacao.views import receita, despesa, transferencia, sucesso, categoria, TransactionScreenView
...
urlpatterns = [   
    ...
    path('transactions', TransactionScreenView.as_view(), name = 'transaction')
]